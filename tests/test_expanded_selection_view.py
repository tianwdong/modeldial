...
class ExpandedSelectionViewCopyTest(unittest.TestCase):
    ...
    def test_radar_uses_explicit_provider_identity_and_bundled_logo_assets(self) -> None:
        ...
        self.assertIn('case "claude-code", "claude": return "anthropic"', self.identity_presentation_source)
        self.assertIn('case "grok-build", "grok-api": return "xai"', self.identity_presentation_source)
