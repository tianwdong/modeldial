<div align="center">
  ...
  <p>
    <a href="https://github.com/tianwdong/modeldial/releases/download/v0.1.0-preview.4/modeldial-0.1.0-preview.4-macos-arm64.dmg"><strong>Download the macOS preview</strong></a>
...
**Current version: [`v0.1.0-preview.4`](https://github.com/tianwdong/modeldial/releases/tag/v0.1.0-preview.4)** · [Direct Apple Silicon DMG download](https://github.com/tianwdong/modeldial/releases/download/v0.1.0-preview.4/modeldial-0.1.0-preview.4-macos-arm64.dmg)
...
> [!IMPORTANT]
> `v0.1.0-preview.4` is an unsigned / unnotarized preview with no Developer ID signature or Apple notarization. If macOS blocks the first launch, use **System Settings → Privacy & Security → Open Anyway** for this app; do not disable Gatekeeper or use `xattr`, `spctl`, or other commands to bypass system security checks.
...
- [Current preview notes](docs/releases/v0.1.0-preview.4.md): installation, verification, and limitations.
