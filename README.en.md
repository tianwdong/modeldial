<div align="center">
  ...
  <p>
    <strong><a href="https://github.com/tianwdong/modeldial/releases/tag/v0.1.0-preview.12">Download macOS preview.12</a></strong>
...
> [!CAUTION]
> `preview.12` fixes the nested-signing issue that could prevent the frozen backend and Sparkle components in `preview.11` from loading on normally protected Macs. This build is still unsigned and unnotarized; review the installation boundary below and do not disable or bypass Gatekeeper for first launch.
...
**Latest published version: [`v0.1.0-preview.12`](https://github.com/tianwdong/modeldial/releases/tag/v0.1.0-preview.12)**
...
This is a ModelDial-maintained personal tap, not the official `homebrew/cask`. The cask downloads the exact `preview.12` DMG published on GitHub Releases and pins its SHA-256; later app updates still use the signed Sparkle preview channel.
...
Download [`modeldial-0.1.0-preview.12-macos-arm64.dmg`](https://github.com/tianwdong/modeldial/releases/download/v0.1.0-preview.12/modeldial-0.1.0-preview.12-macos-arm64.dmg). Download [`SHA256SUMS`](https://github.com/tianwdong/modeldial/releases/download/v0.1.0-preview.12/SHA256SUMS) as well if you want to verify the file.
...
- [Current preview notes](docs/releases/v0.1.0-preview.12.md): installation, verification, and limitations.
