...
This is a ModelDial-maintained personal tap, not the official `homebrew/cask`. The cask downloads the exact `preview.11` DMG published on GitHub Releases and pins its SHA-256; later app updates still use the signed Sparkle preview channel.
...
- [Current preview notes](docs/releases/v0.1.0-preview.11.md): installation, verification, and limitations.
