<div align="center">
  ...
  <p>
    <strong><a href="https://github.com/tianwdong/modeldial/releases/tag/v0.1.0-preview.17">Download macOS preview.17</a></strong>
...
> [!CAUTION]
> `preview.17` restores official incremental leaderboard refresh, preserves per-model scoring provenance, and fixes model brand icons. This build is still unsigned and unnotarized; review the installation boundary below and do not disable or bypass Gatekeeper for first launch.
...
**Latest published version: [`v0.1.0-preview.17`](https://github.com/tianwdong/modeldial/releases/tag/v0.1.0-preview.17)**
...
This is a ModelDial-maintained personal tap, not the official `homebrew/cask`. The cask downloads the exact `preview.17` DMG published on GitHub Releases and pins its SHA-256; later app updates still use the signed Sparkle preview channel.
...
Download [`modeldial-0.1.0-preview.17-macos-arm64.dmg`](https://github.com/tianwdong/modeldial/releases/download/v0.1.0-preview.17/modeldial-0.1.0-preview.17-macos-arm64.dmg). Download [`SHA256SUMS`](https://github.com/tianwdong/modeldial/releases/download/v0.1.0-preview.17/SHA256SUMS) as well if you want to verify the file.
...
- [Current preview notes](docs/releases/v0.1.0-preview.17.md): installation, verification, and limitations.
